...
from .processors.classification import preprocess_answer_dataset, preprocess_answer_g_dataset, preprocess_answer_dg_dataset
...
def get_preprocess_and_print_func(
    ...
    stage: Literal["pt", "sft", "rm", "ppo", "kto", "orm", "orm_g", "orm_dg", "taorm", "taorm_sft"],
    template: "Template",
